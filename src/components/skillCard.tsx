...
export default function SkillCard(params: SkillCard) {
  return (
    ...
    >
      <div className="flex justify-center items-center flex-shrink-0 sm:h-12 sm:w-12 h-7 w-7 rounded-full bg-white text-lg sm:text-2xl text-indigo-900 shadow-md shadow-black group-hover:scale-[110%] group-hover:shadow-indigo-700 group-hover:shadow-lg transition-all duration-500">
        {params.card}
      </div>
