...
import Guitar from "@/components/canvas/GuitarCanvas";
      ...
      <main className="h-screen  w-screen bg-gradient-to-tr from-blue-900 from-10% via-gray-900 via-80% to-blue-950 text-white box-border absolute overflow-y-scroll scrollbar-none">
        ...
        >
          <div className="h-fit sm:w-2/3 w-5/6 flex items-center flex-col sm:flex-row sm:mt-0 mt-20">
            <motion.div
              className="w-fit h-fit flex justify-center items-center bg-gradient-to-l from-indigo-900 to-indigo-700 bg-opacity-30 p-2 overflow-hidden mr-8 sm:mt-0 mt-14"
            ...
            <motion.div
              className="sm:w-[0.35rem] sm:h-full bg-gradient-to-b to-indigo-900 from-indigo-400 rounded-full sm:block hidden"
              initial={{ height: "0" }}
            ...
            >
              <motion.div
                className="mb-5 h-fit w-fit p-8 flex flex-col justify-center items-start z-30 gap-10"
                initial={{ opacity: "0" }}
                animate={{ opacity: "1" }}
                transition={{ delay: 1.0, duration: 0.4 }}
              >
                <h1 className="text-center mb-1 font-extrabold text-gray-100 text-4xl sm:text-[5rem] [text-shadow:_0_2px_2px_var(--tw-shadow-color)] shadow-[#00000028]">
                {lang === "en" ? mainTxtEng.welcome : mainTxtPt.welcome} <span className="text-indigo-400">Lucas</span>
                </h1>
                <p className="text-white sm:text-xl text-md [text-shadow:_0_2px_2px_var(--tw-shadow-color)] shadow-[#00000028]">
                  FullStack Web Developer.
                  <br /> Front End Developer, React.js, Next.js {lang === "en" ? "and" : "e"} Vue.js.
                  <br /> Back End Developer, Node.js, Express {lang === "en" ? "and" : "e"} Nest.js.
                </p>
        ...
        <div className="w-full h-fit -mt-20 mb-20 flex sm:flex-row flex-col items-start" id="contact">
          <Contact />
          <Planet />
        </div>
      </main>
